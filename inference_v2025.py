...
def main(argv):
  ...
  for i in range(len(valid_tickers)):
    ...
    # sort the features based on the importancies:
    feature_file_path = f'./processed_data_2025_{period}/features/sorted_features_{stock_name}.txt'
    ...
    study_rf_name = f'study_rf_columns_{n_columns}_stocks_{stock_name}_period_{period}'
    ...
    study_svm_name = f'study_svm_columns_{n_columns}_stocks_{stock_name}_period_{period}'
